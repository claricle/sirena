...
module Sirena
  module Parser
    module Builders
      ...
      # fully-formed Diagram::Gantt object with sections and tasks.
      class Gantt
        ...
        # @return [Diagram::Gantt] the gantt chart diagram model
        def apply(tree)
        ...
        # Gantt#resolve_task_dependency, which reads calculated
