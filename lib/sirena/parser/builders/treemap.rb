    ...
    module Builders
      ...
      class Treemap < Parslet::Transform
        ...
        class << self
          ...
          # Diagram::Treemap from its intermediate statement list.
          #
          # This is the method Treemap calls — it is the single
          ...
          # Builds Treemap from the intermediate statement list.
          #
