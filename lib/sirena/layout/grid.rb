...
module Sirena
  module Layout
    ...
    #
    # Temporary: TODO.architecture item 06 deletes this class, once
    # Engine no longer receives a legacy graph result to position. It has
    # no successor and is not what elkrb replaces; delete it, do not
    # extend it. The geometry lives here rather than in the engine so the
    # engine stays about the pipeline.
    #
    ...
    class Grid
      ...
      #
      # Renderer::Flowchart#cluster? is the second copy of this.
      def cluster?(child)
