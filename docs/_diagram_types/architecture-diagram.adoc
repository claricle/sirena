...
. **Builder** ([`lib/sirena/parser/builders/architecture.rb`](lib/sirena/parser/builders/architecture.rb)) - Converts parse tree to model
. **Parser** ([`lib/sirena/parser/architecture.rb`](lib/sirena/parser/architecture.rb)) - Orchestrates parsing pipeline
. **Layout** ([`lib/sirena/layout/architecture.rb`](lib/sirena/layout/architecture.rb)) - Positions elements spatially
