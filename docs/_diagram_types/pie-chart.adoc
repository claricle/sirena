...
* [`Parser::Builders::Pie`](../lib/sirena/parser/builders/pie.rb) - Parse tree builder
* [`Parser::Pie`](../lib/sirena/parser/pie.rb) - Main parser
* [`Layout::Pie`](../lib/sirena/layout/pie.rb) - Graph layout
* [`Renderer::Pie`](../lib/sirena/renderer/pie.rb) - SVG renderer
...
* Coverage against the oracle-valid mermaid-js corpus cases: `--> against valid cases only: 40/40 = 100.0%` (`bundle exec ruby scripts/corpus_sweep.rb --failing pie`, BY VERDICT section). The remaining 9 corpus cases are outside the oracle-valid set: 1 `artifact`, 6 `invalid`, 2 `unknown`, per `spec/mermaid/corpus-verdicts.yml`.
...
* https://github.com/claricle/sirena/blob/main/lib/sirena/diagram/pie.rb[Pie Diagram Model]
* https://github.com/claricle/sirena/blob/main/lib/sirena/renderer/pie.rb[Pie Renderer]