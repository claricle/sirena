...
* **16/16 = 100.0% of oracle-valid mermaid-js corpus cases passing** (`bundle exec ruby scripts/corpus_sweep.rb --failing timeline`, valid-cases line)
* The 17th corpus fixture contains invalid syntax ("Timeline diagram" instead of "timeline") and is excluded from the oracle-valid denominator
