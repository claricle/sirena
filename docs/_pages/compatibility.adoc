...
* **C4 Diagram** (all 5 types) - Context, Container, Component, Dynamic, Deployment; see link:../../diagram_types/c4-diagram/[C4 Diagram] for known limitations (variable syntax, sprites/links/tags, fallback-grid layout)
