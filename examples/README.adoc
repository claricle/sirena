...
* link:gantt/02-task-dependencies.mmd[02-task-dependencies] - Two-phase project schedule
...
* `.svg` file - Rendered SVG output (generated); one source (`packet/01-basic-packet.beta.mmd`) has no rendered SVG yet
